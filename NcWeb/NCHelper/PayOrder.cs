...
namespace NCHelper
{
    ...
    {
        [XmlElement(ElementName = "eb")]
        public eb Detial { get; set; }

        public class eb
        {
            public Pub pub { get; set; }

            public Instruct @in { get; set; }

            public eb()
            {
                this.pub = new Pub();
                this.@in = new Instruct();
            }
        }
        ...
        public class Rd
        {
            public Rd()
            {
                PayAccNo = Common.PayAccNo;
                PayAccNameCN = Common.PayAccNameCN;
                CurrType = Common.CurrType;
                ReimburseNo = "";
                ReimburseNum = "";
                StartDate = "";
                StartTime = "";
